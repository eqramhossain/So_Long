...
/*   Updated: 2025/03/09 11:47:52 by ehossain         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(int ac, char *av[])
{
	...
	mlx_put_image_to_window(map.mlx_ptr, map.win_ptr, img.main_img, 50, 0);
	mlx_put_image_to_window(map.mlx_ptr, map.win_ptr, img.collect_img, 100, 0);
